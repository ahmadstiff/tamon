...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      // `steer` already implies pointerAngle is non-null, but the narrowing doesn't survive the
      // intermediate boolean, so it's repeated here. Upstream ships this as a type error under
      // strict mode; behaviour is unchanged.
