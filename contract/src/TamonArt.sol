...
library TamonArt {
    ...
    string internal constant HEAD =
        "<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 400'><rect width='400' height='400' fill='#0E1014'/>";
    string internal constant BASE =
        "<path d='M98 183L142 97L236 81L308 139L318 235L262 313L162 319L82 249Z' fill='#6E7480' stroke='#262A31' stroke-width='5'/>"; // A1
    string internal constant TAIL = "</svg>";

    // ------------------------------------------------------------ A2 layers
    string internal constant L_UTUH =
        "<path d='M124 172L160 110L230 98L186 174Z' fill='#8F959F' opacity='.55'/>";
    string internal constant L_LAPUK =
        "<path d='M152 126L170 178L156 232M216 106L230 158' fill='none' stroke='#262A31' stroke-width='3' opacity='.6'/>";
    string internal constant L_RETAK =
        "<path d='M150 118L172 176L154 234L174 290M216 100L230 156L208 208M262 134L248 192L270 246M120 206L158 224' fill='none' stroke='#1A1D22' stroke-width='4'/>";
    string internal constant L_HANCUR =
        "<path d='M190 81L212 200L188 319L156 318L184 198L162 90ZM260 96L242 200L262 312L282 306L262 200L280 108Z' fill='#0E1014'/><path d='M92 336L120 326L108 354ZM286 342L312 330L300 358Z' fill='#6E7480'/>";
    string internal constant L_KRISTAL =
        "<path d='M200 94L288 150L260 248L162 270L108 188Z' fill='#E8B23A' opacity='.9'/><path d='M200 94L162 270M108 188L288 150M200 94L260 248' fill='none' stroke='#0E1014' stroke-width='3' opacity='.45'/><path d='M296 106L302 126L322 132L302 138L296 158L290 138L270 132L290 126Z' fill='#F2F0EC'/>";

    // ------------------------------------------------------------ A3 badges
    string internal constant B_BRONZE = "<path d='M352 34L364 48L352 62L340 48Z' fill='#8A5A2B'/>";
    string internal constant B_SILVER =
        "<path d='M352 34L364 48L352 62L340 48ZM322 34L334 48L322 62L310 48Z' fill='#C8CDD4'/>";
    string internal constant B_GOLD =
        "<path d='M352 34L364 48L352 62L340 48ZM322 34L334 48L322 62L310 48ZM292 34L304 48L292 62L280 48Z' fill='#E8B23A'/>";
